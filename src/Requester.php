...
class Requester {
    ...
    /**
     * 发起请求
     * @param string $http_method 发起请求方式;有GET|POST|PUT|DELETE
     * @param string $path 请求方法
     * @param array $headers 请求header头
    ...
    */
    protected function createRequest ($http_method, $path, $headers = array(), $params = null) {
        ...
        // 生成数字签名
        $query['sign'] = TeegonSign::produce($http_method, $url_arr['path'], $headers, $query, $postData, $this->app_secret);
